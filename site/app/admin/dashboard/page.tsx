  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="w-full max-w-[1920px] mx-auto px-8 lg:px-12 py-8">
        ...
        <CollapsibleSection id="aeo-tests"
        ...
        {/* AI Engine Traffic */}
        <CollapsibleSection id="ai-engines"
        ...
        <CollapsibleSection id="content-comparison"
        ...
        {/* Traffic & Testing */}
        <CollapsibleSection id="quick-stats"
